...
import { ImportInfo, TemplateInfo } from '../type'
...
export const generateId = (value: string, templateInfo: TemplateInfo) => {
...
export const generateTemplateLiteralParamsKey = (i: number) => {
  return `{{@${i}=}}`
}
